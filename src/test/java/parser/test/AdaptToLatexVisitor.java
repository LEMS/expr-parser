...
public class AdaptToLatexVisitor extends AAdaptToLangVisitor {
	...
	public String visitPow(LEMSExpressionParser.PowContext ctx) {
		List<Integer> needFlippedExponent = Arrays.asList(
				LEMSExpressionParser.SIN, LEMSExpressionParser.COS, LEMSExpressionParser.TAN,
				LEMSExpressionParser.SINH, LEMSExpressionParser.COSH, LEMSExpressionParser.TANH);
